...
class TraversabilityEstimator:
	...
	def features_callback(self, msg):
		# Error protection for malformed JSON or missing fields
		try:
			data = json.loads(msg.data)
		except json.JSONDecodeError:
			rospy.logerr("Failed to decode terrain features JSON")
			return
	...
	# Helper to print the map and save the image together
	def print_and_save(self, event=None):
		self.print_map()
		self.save_map_image()

	# Function to print the traversability map as text in the console
	def print_map(self):
